    ...
    <>
      <div className="card overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100">
          <h3 className="text-[15px] font-semibold text-gray-900">My Payslips</h3>
          <p className="text-xs text-gray-500 mt-0.5">{payslips.length} payslips</p>
        </div>
            ...
            <tbody className="divide-y divide-gray-100">
              {payslips.map((ps) => (
                <tr key={ps.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 font-medium text-gray-800">{MONTHS[ps.month - 1]}</td>
                  <td className="px-4 py-3 text-gray-600">{ps.year}</td>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-xs text-gray-500 hover:text-gray-700
                          px-2 py-1 rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50"
                      >
                        <Download size={12} />
