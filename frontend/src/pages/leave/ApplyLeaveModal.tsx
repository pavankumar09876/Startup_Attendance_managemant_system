      ...
      <div className="flex items-center gap-2 mb-6">
        {([1, 2] as const).map((s) => (
          <div key={s} className="flex items-center gap-2">
            ...
            {s < 2 && <ArrowRight size={12} className="text-gray-300" />}
          </div>
        ))}
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className={cn(
                  'w-full px-3 py-2.5 rounded-lg border text-sm',
                  'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50',
          ...
          {dayCount > 0 && (
            <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <span className="text-xs text-blue-500">(weekends excluded)</span>
            </div>
          )}
          ...
          <div className="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-xl">
            <div>
              <p className="text-sm font-medium text-gray-800">Half day leave</p>
              <p className="text-xs text-gray-500">Apply for only half the day</p>
            </div>
            <Controller
              name="is_half_day"
              control={control}
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className={`text-xs ${watchedReason.length < 10 ? 'text-red-400' : 'text-gray-400'}`}>
      ...
      {step === 2 && (
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
            <p className="text-sm text-gray-600 mb-2">You are applying for:</p>
          ...
          {selectedBalance && !watchedHalfDay && (
            <div className="flex items-center justify-between px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
              ...
              <div className="flex items-center gap-2 text-sm font-semibold">
                <span className="text-gray-700">{selectedBalance.remaining} days</span>
          ...
          <div className="px-4 py-3 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <p className="text-sm text-gray-700">{watch('reason')}</p>
          </div>
